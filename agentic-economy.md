...
- **[GPT-5.5 x402 Gateway](https://gpt55.558686.xyz)** — OpenAI-compatible GPT-5.5 chat and MCP tool gateway with x402 Base USDC settlement. Source: [go165/gpt55-x402-gateway](https://github.com/go165/gpt55-x402-gateway).
